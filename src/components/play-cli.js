            ...
            <section className="section">
              <div className="card-content">
                <div className="content is-centered has-text-white">
                  This is a Command Line Interface Application and requires it
                  to be run from the Command Line or Terminal. Please visit the
                  GitHub Repository and follow the instillation steps located in
                  the ReadMe to use the app.
                </div>
              </div>
