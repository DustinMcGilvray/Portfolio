...
const CntrlClick = props => (
  <StaticQuery
    query={graphql`
      query CntrlClickApiQuery {
        allCntrlClick {
          nodes {
            title
            episodes {
      ...
      <div id="podcastPlayerCard" className="card has-text-white equal-height">
        <header className="card-header">
          <p className="card-header-title has-text-white">
            {data.allCntrlClick.nodes[0].title}
          </p>
        ...
        <div className="card-content is-paddingless">
          ...
          >
            <Slider>
              {data.allCntrlClick.nodes[0].episodes.map(episode => (
                <Slide index={1}>
                  <PodcastPlayer
                    title={episode.title}
